...
public class Test_3 {
	...
	@Test
	void test_4() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
	...
	@Test
	void test_5() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		int tam_ant = contactosCovid.getListaContactos().tamanioLista();
		contactosCovid.loadData("LOCALIZACION;66666666S;25/05/2021;11:01;44.3870;2.4698", false);
		assertEquals((tam_ant + 1), contactosCovid.getListaContactos().tamanioLista());
	}

	@DisplayName("Aniadimos un nuevo nodo temporal al final de la lista")
	@Test
	void test_6() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		contactosCovid.loadData("LOCALIZACION;66666666S;25/05/2021;19:01;44.3870;2.4698", false);
		assertEquals("25/05/2021;16:30 25/05/2021;16:36 25/05/2021;17:18 25/05/2021;18:01 25/05/2021;19:01",
				contactosCovid.getListaContactos().toString());
	}

	@DisplayName("Aniadimos un nuevo nodo temporal en medio de la lista")
	@Test
	void test_7() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		contactosCovid.loadData("LOCALIZACION;12121212R;25/05/2021;17:05;43.3870;2.3698", false);
		assertEquals("25/05/2021;16:30 25/05/2021;16:36 25/05/2021;17:05 25/05/2021;17:18 25/05/2021;18:01",
				contactosCovid.getListaContactos().toString());
	}

	@DisplayName("Comprobamos el numero de personas entre dos instantes temporales")
	@Test
	void test_8() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
	...
	@DisplayName("Comprobamos el numero de personas entre dos instantes temporales")
	@Test
	void test_9() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
	...
	@Test
	void test_10() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		FechaHora ini = new FechaHora(25, 5, 2021, 16, 36);
		FechaHora fin = new FechaHora(25, 5, 2021, 16, 36);
	...
	@Test
	void test_11() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		FechaHora ini = new FechaHora(25, 5, 2021, 16, 30);
	...
	@Test
	void test_12() throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		FechaHora ini = new FechaHora(25, 5, 2021, 16, 36);
		FechaHora fin = new FechaHora(25, 5, 2021, 16, 36);
		assertEquals(3, contactosCovid.getListaContactos().numNodosCoordenadaEntreDosInstantes(ini, fin));
